...
class LabelDialog(QtWidgets.QDialog):
    def __init__(self, **kwargs):
        ...
        show_text_field = kwargs['show_text_field'] if 'show_text_field' in kwargs else None
        fit_to_content = kwargs['fit_to_content'] if 'fit_to_content' in kwargs else None
    ...
    def popUp(self, text=None, move=True, flags=None):
        ...
        if items:
            if len(items) != 1:
                logger.warning("Properties has duplicate '{}'".format(text))
